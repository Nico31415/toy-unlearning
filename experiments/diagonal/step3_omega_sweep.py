#!/usr/bin/env python3
"""
Step 3 Omega Sweep: Run empirical PT+FT Oracle experiments with varying overlap.

Sweeps over omega values {0.0, 0.25, 0.5, 0.75, 1.0} with:
...
# ArgparseArray uses Cartesian product: 5 omega × 13 alpha × 3 seeds = 195 jobs
argparse_array = ArgparseArray(
    ...
    save_folder=(lambda n_train, seed, omega, **kwargs:
                 f"results/diagonal/step3_omega/"
...
def extract_and_save_results(save_folder, alpha, n_train, seed, omega):
    ...
    try:
        ...
        csv_path = os.path.abspath('experiment_results_step3_omega.csv')
...
def main(args):
    ...
    print('='*80)
    print('Step 3 Omega Sweep - Experiment Parameters:')
    print('='*80)
