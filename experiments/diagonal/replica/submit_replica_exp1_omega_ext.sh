...
#SBATCH --job-name=rep_exp1_omext
...
echo "============================================"
echo "Replica Exp1 omega-extension: Task ID $SLURM_ARRAY_TASK_ID"
echo "Hostname: $(hostname)"
echo "Start time: $(date)"
echo "============================================"

$PY experiments/diagonal/replica/compute_replica_curves_worker_exp1_omega_ext.py \
