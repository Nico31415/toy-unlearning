#!/bin/bash
#SBATCH --job-name=emp_sanity_o09
...
#SBATCH --output=logs/emp_sanity_o09_%A_%a.out
#SBATCH --error=logs/emp_sanity_o09_%A_%a.err

set -euo pipefail

REPO_ROOT="${REPO_ROOT:-/home/na658/multi-task2}"
PY="${PY:-/home/na658/.conda/envs/mtl_ft/bin/python}"
OUT_DIR="${OUT_DIR:-$REPO_ROOT/results/sanity_check_omega09}"
