#!/usr/bin/env python3
"""
Step 1 Mixture Sweep: Run empirical experiments with mixture-k heterogeneous initialization.
...
# ArgparseArray uses Cartesian product: 3 pi_A × 13 alpha × 3 seeds = 117 jobs
argparse_array = ArgparseArray(
    ...
    save_folder=(lambda n_train, seed, pi_A, **kwargs:
                 f"results/diagonal/step1_mixture/"
...
def extract_and_save_results(save_folder, alpha, n_train, seed, pi_A):
    ...
    try:
        ...
        csv_path = os.path.abspath('experiment_results_step1_mixture.csv')
...
def main(args):
    ...
    print('='*80)
    print('Step 1 Mixture Sweep - Experiment Parameters:')
    print('='*80)
