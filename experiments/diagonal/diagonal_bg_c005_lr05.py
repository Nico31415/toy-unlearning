#!/usr/bin/env python3
"""
Diagonal network BG alpha sweep for c=0.05, lr=0.5 with SLURM array job support.
...
def extract_and_save_results(save_folder, alpha, n_train, seed):
    ...
    try:
        ...
        # Append to CSV (separate file for c=0.05)
        csv_path = os.path.abspath('experiment_results_bg_c005_lr05.csv')
...
def main(args):
    ...
    print('='*80)
    print('BG Alpha Sweep (c=0.05, lr=0.5) - Experiment Parameters:')
    print('='*80)
