...
#SBATCH --array=0-35
#SBATCH --output=logs/phase0_step1_%A_%a.out
#SBATCH --error=logs/phase0_step1_%A_%a.err

# Phase 0 Step 1 (mixture): 3 pi_A × 4 alpha × 3 seeds = 36 tasks (0-35)
...
echo "[SLURM] Phase 0 Step 1 Smoke Run"

# Ensure we run from project root and logs exist
cd /home/na658/multi-task2
mkdir -p logs
mkdir -p results/diagonal/phase0/step1
...
$PY experiments/diagonal/phase0_smoke_run.py --phase step1 --task_id $SLURM_ARRAY_TASK_ID
