#!/usr/bin/env python3
"""
Step 2 Support Sweep (Phase 1): Run empirical experiments with support-conditioned c initialization.

PHASE 1 VERSION: Uses updated stopping logic, writes to new output locations.
- Results folder: results/diagonal_phase1/step2_support/
- CSV: experiment_results_step2_support_phase1.csv
...
# ArgparseArray uses Cartesian product: 2 cases × 12 alpha × 3 seeds = 72 jobs
argparse_array = ArgparseArray(
    ...
    save_folder=(lambda n_train, seed, case_idx, **kwargs:
                 f"results/diagonal_phase1/step2_support/"
...
def extract_and_save_results(save_folder, alpha, n_train, seed, c_nz, c_z):
    ...
    try:
        ...
        csv_path = os.path.abspath('experiment_results_step2_support_phase1.csv')
...
def main(args):
    ...
    print('='*80)
    print('Step 2 Support Sweep (PHASE 1) - Experiment Parameters:')
    print('='*80)
